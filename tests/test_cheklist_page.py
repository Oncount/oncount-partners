...
ro = c.get("/cheklist/ai-sotrudnik/oplata", follow_redirects=False)
check(ro.status_code == 302 and ro.headers.get("location") == "https://ardorium.eu/ru/oplata/", "старый адрес страницы оплаты уводит на ARDORIUM")
