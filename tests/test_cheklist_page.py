...
check(all(s in to for s in ("Оплатить рублями", "СБП, картой МИР", "Оплатить любой валютой", "Apple Pay, Visa, Mastercard", "Безопасная оплата", "Старт 29.09 по 1.10", "PayPal", "Криптокошелёк", "TRC-20", "По счёту (ИП / юрлицо)", "Реквизиты вашей компании", "1-3 раб. дня")), "пять способов на странице оплаты словами Николь")
