...
INCLUDES = {
    "monthly": [
        ...
        "Безлимитное количество ответов в течение 15 минут в рабочее время — в личном кабинете клиента или в WhatsApp",
        "Безлимитные инвойсы",
        "Загрузка документов в Google Drive",
        "Безлимитные платежи в банке",
        "Консультация с бухгалтером 60 минут — раз в месяц",
    ...
    "monthly_en": [
        ...
        "Unlimited replies within 15 minutes during business hours — in the client portal or on WhatsApp",
        "Unlimited invoices",
        "Document upload to Google Drive",
        "Unlimited bank payments",
        "A 60-minute consultation with an accountant once a month",
