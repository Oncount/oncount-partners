...
TEXTS: dict[str, dict[str, str]] = {
    ...
    "PARTNER_ONBOARDING_INTRO": {
        "ru": (
            ...
            "<b>Всё просто:</b> знакомите нас с клиентом в один клик → менеджер свяжется в рабочие часы "
        ...
        "en": (
            ...
            "<b>It's simple:</b> introduce a client in one click → a manager reaches out within the hour "
