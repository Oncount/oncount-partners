...
PRODUCTS = [
    {
        ...
        "price_aed": _meta("100% от первого месяца", "от 550 AED/мес"),
    ...
    },
    {
        "slug": "audit",
        "title": "Аудит",
        "price_aed": _meta("$300 с клиента", "от $1 500"),
    ...
    },
    {
        ...
        "price_aed": _meta("$100 с клиента", "от $350"),
    ...
    },
    {
        ...
        "price_aed": _meta("$1 000 с клиента", "по запросу"),
    ...
    },
    {
        ...
        "price_aed": _meta("$300–1 000 с клиента", "по запросу"),
