...
PRODUCTS = [
    {
        ...
        "summary_md": (
            "Основная услуга On Count. Бухгалтерия полного цикла для компаний в ОАЭ. "
        ...
        "full_md": (
            "<h4>Чем отличается бухгалтерия On Count</h4>"
            "<ul>"
            ...
            "Если бухгалтер ошибается — штрафы FTA и финансовые потери покрывает On Count, "
